...
public class OnlySendDataToDocumentsBackground extends AsyncTask<String, String, String> {
    ...
    public OnlySendDataToDocumentsBackground(DatabaseHelper db) {
        this.db = db;
    ...
    protected void onPostExecute(String s) {
        ...
        for (Documents document : documentsForAddAndUpdateList) {
            db.updateDocumentSynced(document);
        }
    }
}
